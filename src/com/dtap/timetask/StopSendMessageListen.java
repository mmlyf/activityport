...
import com.dtap.timetask.taskimpl.StopSendMessageTimeWork;
 ...
 */
@WebListener
public class StopSendMessageListen implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent arg0)  { 
		...
		timer.schedule(new StopSendMessageTimeWork(), date, period);
	}
